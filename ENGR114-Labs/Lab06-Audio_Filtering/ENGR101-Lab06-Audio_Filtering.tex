...
\newcommand{\labtitle}{01 Lab06 Audio Filtering} 
...
\pagestyle{fancy}
    ...
    \hypertarget{lab-06---audio-filtering}{%
\section{Lab 06 - Audio Filtering}\label{lab-06---audio-filtering}}

    \hypertarget{deliverables}{%
\subsection{Deliverables}\label{deliverables}}

Each student's submission for the lab should be one of the following
files (you do not need to submit all the .py files used in the lab, just
the .py files you were primarily responsible for). Upload these two
files to the D2L Lab 6 Uploads folder.
